...
st.title('Avaliação de Crédito') # Titulo 

#Abrindo o arquivo de configuração
with open('config.yaml', 'r') as file:
    config = yaml.safe_load(file)
    url = config['url_api']['url'] #Chama as configurações da API"Caminho"
...
#Criando o formulario com os campo
with st.form(key='prediction_form'):
    ...
    valor_solicitado = st.number_input('Valor solicitado',
    ...
    #Dicinario com os novos dados que serão inseridos
if submit_button:
    dados_novos = {
        'profissao' : [profissao],
    ...
    #Realizando a requisição a API com os dados novos
